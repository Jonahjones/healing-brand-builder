      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="text-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gentle-terracotta/10 rounded-xl flex items-center justify-center mx-auto mb-2 sm:mb-3">
              <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-gentle-terracotta" />
            </div>
