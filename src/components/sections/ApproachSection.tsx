...
export default function ApproachSection({ withId = true }: { withId?: boolean }) {
  ...
  return (
    <section id={withId ? "approach" : undefined} data-page-hero className="pt-24 pb-16 bg-gradient-to-br from-warm-cream via-white to-natural-beige relative overflow-hidden min-h-screen">
